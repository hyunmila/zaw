...
weights_f = "/home/probook/Documents/repos/zaw/lab10/yolov3_training_last_f.weights"
cfg_f = "/home/probook/Documents/repos/zaw/lab10/yolov3_testing_f.cfg"
###################################
...
if FUSION == "LATE":
    net_therm = cv2.dnn.readNetFromDarknet('yolov3_training_last_t.weights', 'yolov3_testing_t.cfg')
    net_rgb = cv2.dnn.readNetFromDarknet('yolov3_training_last_c.weights', 'yolov3_testing_c.cfg')
    ...
    if FUSION == "LATE":
        ...
        for rect1 in Rect1:
            for rect2 in Rect2:
                ...
                if iou_value > 0:
                    boxes_iou.append([(Rect1.index(rect1), Rect2.index(rect2)), iou_value])
